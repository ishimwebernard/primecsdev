...
construction: "option"+document.getElementById('construction').checked,
cv: i('someCv'),//file
dateOfBirth: i('dateOfBirth'),
emailAddress: i('emailAddress'),
engineering: "option"+document.getElementById('engineering').checked,
...
async function transferApplication(userObject){
    ...
    let someCV = document.getElementById('someCv').files[0];
